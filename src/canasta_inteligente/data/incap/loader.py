...
class Nutrition_INCAP(DataLoader):
    ...
    CACHE_SCHEMA = {
        "data": DataLoader.CACHE_DIR / "incap_data.pkl",
        "categories": DataLoader.CACHE_DIR / "incap_categories.pkl",
    }
    categories: dict
...
if __name__ == "__main__":
    incap_data = Nutrition_INCAP("./data/raw/incap/tabladecomposiciondealimentos.pdf")
